...
def parseProgramArgs(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            print("e.g. masks, other channels etc. they can be processed all together. Naming convenction is important")
            ...
            print("Examplary names:")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_1.pgQP")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_1.QCONF")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_1.tif")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_1_0.stQP.csv")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_1_snakemask.tif")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_2.tif")
            print("KZ4-220214-ABD-GFP-dev6h-agar2+TRITC-2.lsm_CH_DIC.tif")
            print("Then tails should be:")
